...
if ( ! function_exists( 'understrap_scripts' ) ) {
	...
	function understrap_scripts() {
		...
		wp_register_script('jquery-1',  'https://ajax.googleapis.com/ajax/libs/jquery/1.11.0/jquery.min.js', false, '1.14.3', true);
		wp_enqueue_script('jquery-1');
		wp_register_script('parallax-js',  'https://cdn.jsdelivr.net/parallax.js/1.4.2/parallax.min.js', false, '1.14.3', true);
